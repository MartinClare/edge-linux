...
echo "[2/5] Installing local service units..."
...
echo "[3/5] Installing VPN sudoers rule for backend..."
...
sudo systemctl restart edge-cloud-local edge-ui-local edge-python-local
